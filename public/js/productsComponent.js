const products = {
  props: ['products'],
  template: `
  <div class="items_card" data-id="1" data-name="{{item.name}}" data-price="52">
  <img class="image_card" src="/img/itemscard1.jpg" alt="photo">
  <a href="/public/catalog.html" class="featured_card_zag">ELLERY X M'O CAPSULE</a>
  ...
  <p class="featured_card_price">{{item.price}}</p>
